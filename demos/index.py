...
from demos.tools.sql_translator.tool import sql_translator, SQLQueryFixer, sql_filter_tool
...
tools = [
    ...
    sql_db_query,
    # InputFormatterTool(),
    # SQLQueryFixer(db_schema="dbo_v2"),
]
...
q13 = "hello"
q12 = "find average effective flow time recorded in August 2023 for each the measurement system from the computer with tag FQI-EMED_05-08-1o"
q15 = "find the average temperature for the computer with tag FQI-EMED_05-08-1O"
