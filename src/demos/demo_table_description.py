...
from src.sql_toolkit.sql_toolkit import CustomSQLToolkit, SQLDatabaseInfo, get_tables_descriptions
...
# Creating embeddings
ruta_completa = os.path.abspath('../langchain_demo_lauther/src/dictionary/data_descriptions.csv')
data = pd.read_csv(ruta_completa, delimiter=';')
get_tables_descriptions(data, ["fcs_computadores"])
